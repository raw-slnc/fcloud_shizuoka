...
from qgis.PyQt.QtCore import Qt, QTimer, QUrl, QMetaType
...
class RinchiMixin:
    ...
    def _build_tab_rinchi(self):
        ...
        self.combo_rinchi_shinseisha.setInsertPolicy(QComboBox.InsertPolicy.NoInsert)
    ...
    def _build_rinchi_vector_layer(self):
        ...
        pr.addAttributes([
            QgsField('kubun', QMetaType.Type.QString),
            QgsField('permit_no', QMetaType.Type.QString),
            QgsField('applicant', QMetaType.Type.QString),
            QgsField('purpose', QMetaType.Type.QString),
            QgsField('purpose_detail', QMetaType.Type.QString),
            QgsField('city', QMetaType.Type.QString),
            QgsField('city_short', QMetaType.Type.QString),
            QgsField('address', QMetaType.Type.QString),
            QgsField('norin', QMetaType.Type.QString),
            QgsField('permit_date', QMetaType.Type.QString),
            QgsField('project_ha', QMetaType.Type.Double),
            QgsField('forest_ha', QMetaType.Type.Double),
            QgsField('permit_ha', QMetaType.Type.Double),
        ])
        layer.updateFields()
