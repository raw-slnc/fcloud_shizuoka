...
class HoanrinMixin:
    ...
    def _build_tab_hoanrin(self):
        ...
        self.combo_hoanrin_city.setInsertPolicy(QComboBox.InsertPolicy.NoInsert)
        ...
        self.combo_hoanrin_daiji.setInsertPolicy(QComboBox.InsertPolicy.NoInsert)
        ...
        self.combo_hoanrin_koaza.setInsertPolicy(QComboBox.InsertPolicy.NoInsert)
        ...
        self.combo_hoanrin_shubetsu.setInsertPolicy(QComboBox.InsertPolicy.NoInsert)
    ...
    def _resync_hoanrin_match_column(self):
        ...
        for row_i in range(tbl.rowCount()):
            ...
            if it is None:
                continue
            rec = it.data(Qt.ItemDataRole.UserRole)
    ...
    def _filter_and_display_hoanrin(self):
        ...
        for row_i, rec in enumerate(records):
            ...
            st_item.setData(Qt.ItemDataRole.UserRole, rec)
        ...
        if keep_ids is not None:
            ...
            if tree is not None:
                for i in range(tree.topLevelItemCount() - 1, -1, -1):
                    ...
                    if it.data(0, Qt.ItemDataRole.UserRole) not in keep_ids:
